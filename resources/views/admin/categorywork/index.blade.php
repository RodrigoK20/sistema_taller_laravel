...
<div class="content-wrapper">
    ...
    <a href="{{route('categorieswork.create')}}">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                            @foreach ($categoriesworks as $category)
                                <tr>
                                    ...
                                    <td style="width: 50px;">
                                        ...
                                        <button class="btn btn-danger eliminar " style="height:35px;width:50px"  href="{{route('categorieswork.destroy', $category)}}" type="submit" title="Eliminar">
